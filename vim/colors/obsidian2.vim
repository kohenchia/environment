...
" Groups
execute "hi Cursor guifg="      . s:Colors[12] . " guibg=" . s:Colors[1]  . " gui=none"
...
execute "hi CursorLineNr guibg=". s:Colors[9]  . " gui=none"
execute "hi MatchParen guifg="  . s:Colors[12] . " guibg=" . s:Colors[11] . " gui=none"
execute "hi ModeMsg guifg="     . s:Colors[1]  . " guibg=" . s:Colors[12] . " gui=none"
execute "hi MoreMsg guifg="     . s:Colors[1]  . " guibg=" . s:Colors[12] . " gui=none"
execute "hi NonText guifg="     . s:Colors[13] . " guibg=" . s:Colors[12] . " gui=none"
